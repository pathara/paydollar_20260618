    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logochange.attr('src', 'https://www.paydollar.com/asset/img/logo/logo-paydollar-h120px.png');
                logodefault.attr('src', 'https://www.paydollar.com/asset/img/logo/logo-paydollar-h120px.png');
            } 
            else {
